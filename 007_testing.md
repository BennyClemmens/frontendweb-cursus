...
> ```
>
> Vergeet geen `.env` aan te maken! Bekijk de [README](https://github.com/HOGENT-frontendweb/webservices-budget?tab=readme-ov-file#web-services-budget) voor meer informatie. voor meer informatie.
...
![Eerste keer Cypress runnen (stap 1)](./img/7_1_startscherm_cypress.png ':size=80%')
...
![Eerste keer Cypress runnen (stap 2)](./img/7_2_startscherm_cypress.png ':size=80%')
...
![Eerste keer Cypress runnen (stap 3)](./img/7_3_startscherm_cypress.png ':size=80%')
...
![Eerste keer Cypress runnen (stap 4)](./img/7_4_startscherm_cypress.png ':size=80%')
...
Laatste aanpassing op 02/11/2025 19:09
