...
<html>
  <body>
    ...
    <script>
      document.getElementById('name').innerHTML = 'rudy';
    </script>
  </body>
</html>
```
...
<p align="center">
  <img src="img/vite_ESModules.webp" style="width:50%" alt="vite_ESModules">
</p>
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/vite_bundling.png" style="width:50%" alt="vite_bundling">
</p>
<!-- markdownlint-ensable -->
...
- (5) `plugins` voegt extra regels of functionaliteit toe aan ESLint, maar activeert die regels niet automatisch. Je moet ze dan zelf toevoegen aan rules.
  - Importeer de `@stylistic/eslint-plugin-js` plugin.
  - Voeg de plugin toe aan de `plugins` property.
...
Components zijn niets meer dan functies die de HTML, die getoond moet worden door deze component, teruggeeft. Hier voegen we hard gecodeerde tekst toe want weten of een lege component correct gerenderd wordt is nogal lastig.
...
Hoe krijg je nu de juiste data in de `props` van een component? In `App.jsx` willen we:
...
Het zou handig zijn als we in VS Code konden debuggen... Uiteraard kan dit ook. [Lees in deze tutorial hoe je dit opzet](https://profy.dev/article/debug-react-vscode). Tip: onze webapplicatie draait op `http://localhost:5173`.
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/todo-app-screenshot.png" style="width:50%" alt="todo-app-screenshot">
</p>
<!-- markdownlint-ensable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/props.svg" style="width:50%" alt="props">
</p>
<!-- markdownlint-ensable -->
