# [^](README.md) Front-end Web Development Opdracht 2025 - 2026

## De opdracht

Gedurende het semester maak je een webapplicatie bestaande uit een front-end gedeelte in React en, indien je het olod Web Services ook volgt, een bijhorende back-end in NodeJS. Indien je het olod Web Services niet volgt, zie [verder](#indien-je-het-olod-web-services-niet-volgt)
...
- Het dossier is volledig en tijdig ingediend (zie sectie 4 voor de vereisten)
...
## Indien je het olod Web Services niet volgt
